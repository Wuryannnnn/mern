...
router.get("/instructor/:_instructor_id", (req, res) =>{
  ...
  Course.find({instructor:_instructor_id}).populate("instructor", ["username", "email",]).then((data) =>{
    res.send(data);
  }).catch(()=>{
...
router.get("/findByName/:name", (req,res) => {
  let { name } = req.params;
  Course.find({title: name}).populate("instructor", ["username", "email"]).then(course => {
...
router.get("/student/:_student_id", (req,res)=>{
  ...
  Course.find({students: _student_id}).populate("instructor", ["username", "email"]).then(courses => {
